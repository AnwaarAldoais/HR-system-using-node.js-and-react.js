...
function Departments() {
    ...
    const [holidaystotal, setHolidaysTotal] = useState(1);
    ...
    const ReqState = (hol,e) => {
        e.preventDefault();
        const date1 = new Date(hol.fdate);
        const date2 = new Date(hol.tdate);
        const diffTime = Math.abs(date2 - date1);
        const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24)); 
        if(diffDays===0)
        setHolidaysTotal(1);
        else setHolidaysTotal(diffDays);
        const totalres=hol.total-holidaystotal;
    ...
    return (
        <React.Fragment>
            <WideLayout title="Holidays Requests">
                <Forms>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Add New Holidays Requests</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form>
